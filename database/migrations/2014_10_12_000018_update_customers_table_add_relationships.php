...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('customers', function (Blueprint $table) {
            ...
            $table->foreign('personal_info_id')->references('uuid')->on('customer_personnel_information')->onDelete('set null');
            $table->foreign('category_id')->references('id')->on('customer_categories')->onDelete('set null');
            $table->foreign('address_id')->references('uuid')->on('customer_addresses')->onDelete('set null');
